...
class TagData extends DataClass implements Insertable<TagData> {
  ...
  final String name;
  final String color;
  const TagData({required this.id, required this.name, required this.color});
  @override
  ...
  TagData copyWith({int? id, String? name, String? color}) => TagData(
    id: id ?? this.id,
    name: name ?? this.name,
          ...
          prefetchHooksCallback: ({tasksRefs = false}) {
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (tasksRefs)
                    await $_getPrefetchedData<TagData, $TagsTable, TaskData>(
                      currentTable: table,
